"""
Django settings for acclbooker project.
...
SECRET_KEY = 'django-insecure-pfbl(s(qtba_x+!v^$mvhjo$d5id0qw=d#m@9r9vy2%&_+insh'
...
WSGI_APPLICATION = 'acclbooker.wsgi.application'
